...
| **Oct 29 – 31 2025** | 🧩 [**Agentic-Architecture-EAG-Session6-Assignment**](https://github.com/sushant097/Agentic-Architecture-EAG-Session6-Assignment) | Built an end-to-end “agentic architecture” as part of Session 6 in the EAG course: implementing an AI agent flow with planning, tool-calls and execution logic. | 🧠 *Python · LangChain / Agents · AI-agent Architecture · Session Assignment* |
