...
| **Nov 20 – 28 2025** | 🤖 [**LLM Agents — External APIs & RAG**](https://github.com/sushant097/LLM-Agents-External-APIs) | A **Cortex-style agentic framework** bridging LLMs to the real world. Orchestrates a **Perceive → Plan → Act → Remember** loop using **MCP** to manipulate **Google Sheets, Gmail, and Web Search**. Features a **Telegram gateway** for mobile triggers and end-to-end automation pipelines (e.g., "Scrape F1 stats → Create Sheet → Email User"). | ⚙️ *Python · Gemini 2.0 Flash · MCP (stdio) · Google Sheets & Gmail APIs · FAISS · Trafilatura · MarkItDown · Telegram Gateway* |
| **Nov 29 – Dec 05 2025** | 🧩 [**Hybrid-Agent-Planner**](https://github.com/sushant097/Hybrid-Agent-Planner) | A high-reliability agent prioritizing **correctness and cost-efficiency**. Implements a **Hybrid Planning engine** that fuses LLM reasoning with **heuristic guardrails** and **secure Python sandboxing**. Features a **semantic cache (Jaccard similarity)** to instantly recall historical answers, bypassing the planning loop for recurring queries to save tokens. | ⚙️ *Python · Gemini 2.0 / Ollama · FastMCP · AST Sandboxing · Semantic Memory · Historical Indexing · Dynamic Python Code Gen* |
